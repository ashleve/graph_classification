...
# the SimplePixelMnistClassifier you import should be the same as the one you used for training!
from src.models.simple_pixel_mnist_classifier import SimplePixelMnistClassifier
...
def predict():
    """
        ...
        Model used in simple_pixel_mnist_classifier.py should be the same as during training!!!
    """

    CKPT_PATH = "epoch=0.ckpt"

    # load model from checkpoint
    trained_model = SimplePixelMnistClassifier.load_from_checkpoint(checkpoint_path=CKPT_PATH)
